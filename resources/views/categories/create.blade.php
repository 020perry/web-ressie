                ...
                <div class="grid grid-cols-1 2xl:grid-cols-2 xl:gap-4 my-4">
                    ...
                    <div class="overflow-x-auto max-h-[600px] bg-white shadow sm:rounded-lg mb-4 p-4 sm:p-6 h-full">
                        ...
                        <form action="{{ route('categories.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="restaurant_id" class="block text-gray-700 text-sm font-bold mb-2">Restaurant</label>
                                <select id="restaurant_id" name="restaurant_id" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
